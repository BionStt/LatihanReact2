...
//import {Constants}  from "./Components/CRUDPost/Constants";
import PostCreateForm from "./Components/CRUDPost/PostCreateForm.js";
import PostUpdateForm from "./Components/CRUDPost/PostUpdateForm.js";

export default function AppForCRUDPost() {
            ...
            <div className="row min-vh-100">
                <div className="col d-flex flex-column justify-content-center align-items-center">
                    {(showingCreateNewPostForm === false && postCurrentlyBeingUpdated === null) && (
                        <div>
                            <h1>ASP.NET Core React CRUD App</h1>
